#!/bin/bash
#SBATCH --job-name=polaris@5e6
#SBATCH --partition=general
#SBATCH --gres=gpu:L40S:2
#SBATCH --cpus-per-task=32
#SBATCH --mem-per-gpu=64G
#SBATCH --time=24:00:00
#SBATCH --output=/home/ssmurali/maxrl/logs/idk/polaris_5e6_%j.out
#SBATCH --error=/home/ssmurali/maxrl/logs/idk/polaris_5e6_%j.err
#SBATCH --requeue
...
# ---------- paths ----------
SAVE_DIR=/data/user_data/ssmurali/idk/polaris_5e6_run
...
echo "[$(date)] IDK GRPO — Polaris, lr=5e-6, bs=32, 2×L40S"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name=polaris_5e6 \
    trainer.default_local_dir=$SAVE_DIR \
    ray_init.ray_dir=$MACHINE_SPECIFIC_RAY_DIR \
    trainer.resume_mode=auto \
    trainer.rollout_data_dir=/home/ssmurali/maxrl/logs/idk/rollouts/polaris_5e6
