#!/bin/bash
#SBATCH --job-name=math@5e6
#SBATCH --partition=general
#SBATCH --gres=gpu:L40S:2
#SBATCH --cpus-per-task=32
#SBATCH --mem-per-gpu=64G
#SBATCH --time=24:00:00
#SBATCH --output=/home/ssmurali/maxrl/logs/idk/math_5e6_%j.out
#SBATCH --error=/home/ssmurali/maxrl/logs/idk/math_5e6_%j.err
#SBATCH --requeue
...
# ---------- paths ----------
SAVE_DIR=/data/user_data/ssmurali/idk/math_5e6_run
REWARD_FN=/home/ssmurali/maxrl/idk/reward_fn.py
TRAIN_DATA=/home/ssmurali/maxrl/data/math12k_idk/train.parquet
...
echo "[$(date)] IDK GRPO — MATH-12K, lr=5e-6, bs=32, 2×L40S"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name=math_5e6 \
    trainer.default_local_dir=$SAVE_DIR \
    ray_init.ray_dir=$MACHINE_SPECIFIC_RAY_DIR \
    trainer.resume_mode=auto \
    trainer.rollout_data_dir=/home/ssmurali/maxrl/logs/idk/rollouts/math_5e6
